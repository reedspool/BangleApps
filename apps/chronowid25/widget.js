(() => {
  ...
  function countDown() {
    ...
    if (settingsChronowid.started && diff < 1000) {
      ...
      require('Storage').writeJSON('chronowid25.json', settingsChronowid);
      clearInterval(interval); //stop interval
      interval = undefined;
    }
    // calculates width and redraws accordingly
    WIDGETS["chronowid25"].redraw();
  }

  // add the widget
  WIDGETS["chronowid25"]={area:"tl",width:0,draw:function() {
    ...
    settingsChronowid = require('Storage').readJSON("chronowid25.json",1)||{};
